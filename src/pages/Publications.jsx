...
const Publications = () => {
  ...
  const publications = [
    ...
    {
      id: 4,
      title: 'EU Brief Σεπτέμβριος',
      description: 'Ενημερωτικό δελτίο της ΕΣΕΕ για τις εξελίξεις στην Ευρωπαϊκή Ένωση κατά τον Σεπτέμβριο.',
      category: 'ΕΥΡΩΠΑΪΚΑ ΔΕΛΤΙΑ',
      date: '2025-09-30',
      size: '2.8 MB',
      format: 'PDF',
      downloadUrl: '/assets/publications/EU Brief_Sept (final) (1).pdf',
      previewImage: '/assets/publications/publications.png'
    }
  ];
