...
const About = () => {
  ...
  const stats = [
    ...
    { icon: <Users className="w-8 h-8" />, number: "354", label: "Εμπορικοί Σύλλογοι" },
    { icon: <Award className="w-8 h-8" />, number: "11", label: "Σύνδεσμοι" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div>
              ...
              <div className={`space-y-6 text-lg leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                ...
                <p>
                  Η ΕΣΕΕ ενώνει 17 Ομοσπονδίες, 354 Εμπορικούς Συλλόγους και 11 Συνδέσμους, 
