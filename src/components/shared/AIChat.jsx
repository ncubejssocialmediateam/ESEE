  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      const aiResponse = {
        id: Date.now() + 1,
        type: 'ai',
        content: 'Ευχαριστώ για την ερώτησή σας! Ως AI βοηθός της ΕΣΕΕ, μπορώ να σας βοηθήσω με θέματα φορολογικής συμμόρφωσης, ψηφιακού μετασχηματισμού, εργατικού δικαίου, εκπαίδευσης και οικονομικής υποστήριξης. Χρησιμοποιήστε τα γρήγορα κουμπιά παρακάτω για συγκεκριμένες κατηγορίες βοήθειας.',
        timestamp: new Date()
      };
      setMessages(prev => [...prev, aiResponse]);
      setIsTyping(false);
