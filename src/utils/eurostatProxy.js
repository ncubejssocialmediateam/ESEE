...
export const fetchEurostatData = async (dataset, params = {}) => {
  try {
    ...
    console.warn('Eurostat API failed, using mock data:', error.message);
    return { success: false, error: error.message, data: getMockData(dataset, params) };
  }
};
 ...
 */
const getMockData = (dataset, params) => {
  const mockData = {
    value: {
